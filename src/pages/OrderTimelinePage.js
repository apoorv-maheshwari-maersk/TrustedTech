        ...
        return (
            <ul className="timeline">
                <li className="event" data-date={dateOfHarvest}>
                    <h3>Medicines Produced</h3>
                    <p>{ cropName } ({ status })</p>
                    <p>Manufacture Date : { dateOfSow }</p>
                    <p>Chemicals used: {fertilizers}</p>
                    <p>Delivery Date : { dateOfHarvest }</p>
                    <p>Place or Warehouse : { trackingLocation[0] }</p>
                </li>
                <li className="event" data-date={uploadDate}>
                    <h3>Medicines Uploaded</h3>
                    <p>{ cropAmount } Unit</p>
                    <p>by { producer }</p>
                    <p>Price : ₹ { price } per Unit</p>
                    <p className="upload-desc">(Medicines uploaded to Trusted Tech, decentralized supplychain.)</p>    
                </li>
                { purchasedElem }
                { track_loc }
            </ul>
        ...
        return(        
            <React.Fragment>
                ...
                <div className="timeline-container">
                    <div id="content">
                        <h2>Know Your Pharmaceutical Supply Chain</h2>
