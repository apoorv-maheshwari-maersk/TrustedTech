                ...
                <section className="addProduct">
                    {
                        ...
                        <>
                            ...
                            <div className="addCrop-container">
                                ...
                                <div className="cropContainer">
                                    <h4><label htmlFor="crop-price">Price (Per Unit)</label></h4>
                                    <input
                                        id="price"
                                        type="number"
                                        name="crop-price"
                                ...
                                <div className="cropContainer">
                                    <h4><label htmlFor="crop-name">Date of Manufacture</label></h4>
                                    <input
                                        id="amount"
                                        type="date"
                                        name="crop-amount"
                                ...
                                <div className="cropContainer">
                                    <h4><label htmlFor="crop-name">Date of Delivery</label></h4>
                                    <input
                                        id="amount"
                                        type="date"
                                        name="crop-amount"
                                ...
                                <div className="cropContainer">
                                    <h4><label htmlFor="crop-price">Place (or Warehouse)</label></h4>
                                    <input
                                        id="location"
                                        type="text"
                                        name="crop-location"
                                ...
                                <div className="cropContainer">
                                    <h4><label htmlFor="crop-price">Amount in Units</label></h4>
                                    <input
                                        id="amount"
                                        type="number"
                                        name="crop-amount"
                                ...
                                <div className="cropContainer">
                                    <h4><label htmlFor="crop-price">Drugs/Chemicals Used</label></h4>
                                    <Dropdown
                                        id="amount"
                                        type="text"
